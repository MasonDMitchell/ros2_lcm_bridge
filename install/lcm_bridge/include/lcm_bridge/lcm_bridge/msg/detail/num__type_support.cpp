...
{
  new (message_memory) lcm_bridge::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lcm_bridge::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[1] = {
  {
    ...
    offsetof(lcm_bridge::msg::Num, num),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Num_message_members = {
  "lcm_bridge::msg",  // message namespace
  "Num",  // message name
  1,  // number of fields
  sizeof(lcm_bridge::msg::Num),
...
get_message_type_support_handle<lcm_bridge::msg::Num>()
{
  return &::lcm_bridge::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lcm_bridge, msg, Num)() {
  return &::lcm_bridge::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
